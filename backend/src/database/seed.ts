...
export async function seedDatabase(dataSource: DataSource) {
  ...
  const specialties = [
    ...
    },
    {
      ...
      icon: '/uploads/specialties/urology_17306383 copy.webp',
