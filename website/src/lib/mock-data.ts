...
export const mockClinics: Clinic[] = [
  {
    ...
    specialties: ['أمراض القلب', 'الجراحة', 'الطوارئ'],
    rating: 4.8,
    openingHours: {
      weekdays: '8:00 ص - 10:00 م',
      weekends: '9:00 ص - 8:00 م',
    },
    facilities: ['مواقف سيارات', 'صيدلية', 'مختبر', 'أشعة'],
    isVerified: true,
  },
  {
    id: '2',
    ...
    email: 'info@childrenhospital.sa',
    image: '/images/clinics/clinic-2.jpg',
    specialties: ['طب الأطفال', 'الولادة', 'الطوارئ'],
    rating: 4.7,
    openingHours: {
      weekdays: '24/7',
      weekends: '24/7',
    },
    facilities: ['طوارئ 24/7', 'صيدلية', 'مختبر', 'أشعة'],
    isVerified: true,
  },
  {
    id: '3',
    name: 'عيادة الأسنان المتخصصة',
    address: 'شارع التحلية، الرياض',
    city: 'الرياض',
    phone: '+966 11 345 6789',
    email: 'info@dentalclinic.sa',
    image: '/images/clinics/clinic-3.jpg',
    specialties: ['طب الأسنان', 'تقويم الأسنان', 'زراعة الأسنان'],
    rating: 4.6,
    openingHours: {
      weekdays: '9:00 ص - 9:00 م',
      weekends: '10:00 ص - 6:00 م',
    },
    facilities: ['مواقف سيارات', 'صيدلية', 'مختبر'],
    isVerified: true,
  },
  {
    id: '4',
    name: 'مستشفى العيون',
    address: 'شارع الملك فيصل، الدمام',
    city: 'الدمام',
    phone: '+966 13 456 7890',
    email: 'info@eyehospital.sa',
    image: '/images/clinics/clinic-4.jpg',
    specialties: ['طب العيون', 'جراحة العيون', 'الليزر'],
    rating: 4.9,
    openingHours: {
      weekdays: '8:00 ص - 8:00 م',
      weekends: '9:00 ص - 5:00 م',
    },
    facilities: ['مواقف سيارات', 'صيدلية', 'مختبر', 'أشعة'],
    isVerified: true,
  },
